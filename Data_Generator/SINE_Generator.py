...
#     stream=SineGenerator(classification_function=0, random_state=0, balance_classes=True),
#     drift_stream=ConceptDriftStream(
#         stream=SineGenerator(classification_function=3, random_state=3, balance_classes=True),
#         drift_stream=SineGenerator(classification_function=1, random_state=1, balance_classes=True),
...
#     stream=SineGenerator(classification_function=2, random_state=20, balance_classes=True),
#     drift_stream=ConceptDriftStream(
#         stream=SineGenerator(classification_function=0, random_state=10, balance_classes=True),
#         drift_stream=SineGenerator(classification_function=3, random_state=30, balance_classes=True),
#         random_state=2, position=5000, width=1
#     ),
#     random_state=0, position=5000, width=1
# )
...
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Large_Abrupt_Target.csv'
# stream = target_large_gradual_generator.next_sample(15000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Large_Gradual_Target.csv'
# stream = target_small_abrupt_generator.next_sample(3000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Small_Abrupt_Target.csv'
# stream = target_small_gradual_generator.next_sample(3000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Small_Gradual_Target.csv'
# stream = source_large_abrupt_generator.next_sample(15000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Large_Abrupt_Source.csv'
# stream = source_large_gradual_generator.next_sample(15000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Large_Gradual_Source.csv'
# stream = source_small_abrupt_generator.next_sample(3000)
# file_name = 'Dissimilar_Datasets/Synthetic/SINE_Small_Abrupt_Source.csv'
stream = source_small_gradual_generator.next_sample(3000)
file_name = 'Dissimilar_Datasets/Synthetic/SINE_Small_Gradual_Source.csv'
