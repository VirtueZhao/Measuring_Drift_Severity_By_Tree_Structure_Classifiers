...
def generate_data(concept_size, drift_type):
    ...
    DD_file = "Case_Study/Case_Study_Results/RandomRBF_" + concept_size + "_" + drift_type + "_DD.csv"
    TDM_file = "Case_Study/Case_Study_Results/RandomRBF_" + concept_size + "_" + drift_type + "_TDM.csv"
